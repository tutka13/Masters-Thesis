...
V skripte \verb|comparison_of_surfaces.py| sa nachádzajú štyri vymodelované plochy pre danú krivku $m(t),$ jednoparametrický systém sfér, jeho obálka, jednoparametrický systém elipsoidov a jeho obálka.
