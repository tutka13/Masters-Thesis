...
%\begin{figure}[h]
%    \centering
%    \subfloat[[width=\textwidth]{images/webbbridge.jpg]{\label{fig:webb_bridge} Contents of the sub-figure}
%	\qquad
%	\subfloat[width=\textwidth]{images/theater.jpg}]{\label{fig:theater} Contents of the sub-figure}
%    \caption{Projekty v architektúre.}
%    \label{fig:projects}
%\end{figure}
