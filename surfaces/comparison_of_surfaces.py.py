...
for i in range(number_of_ellipsoids):
    # Spheres
    bpy.ops.mesh.primitive_uv_sphere_add(radius=radii[i], location=f.shift_x(points[i], shift_array[0]+15))
    bpy.ops.object.shade_smooth()
   
    # Circle
    bpy.ops.mesh.primitive_circle_add(radius=radii_char[i], location=f.shift_x(center_char[i], shift_array[1]+15))
    circle_object = bpy.context.object
...
#bpy.ops.wm.save_as_mainfile(filepath='C:/Users/tutko/Desktop/Masters-Thesis/surfaces/outputs_all/' + text_file + '.blend') 
